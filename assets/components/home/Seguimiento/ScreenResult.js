...
const txtDesc = Platform.OS !== 'ios' ? responsiveFontSize(1.5):responsiveFontSize(1.6);
const txtHelp = Platform.OS !== 'ios' ? responsiveFontSize(1.4):responsiveFontSize(1.5);
...
export default function Header({data}) {
    ...
    function Detailers({data}) {
        let none =
            'id_asunto_actual,id_auditoria,tipo_dano,identificador_dispositivo,id_respuesta,id_reporte,codigo_barrio,codigo_comuna,despues,id_tipo_reporte,x,y,ruta_respuestaruta_imagen,responsable';
        let General = [];
