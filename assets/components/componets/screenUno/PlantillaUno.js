...
export default props => {
    ...
    return (
        <View style={styles.Container}>
            ...
            <Renderload
                load={props.load}
                setLoadVisible={props.setLoadVisible}
            />
            <WebView
                ref={props.Map_Ref}
                onMessage={event => {
            ...
            <View style={[styles.contenedor]}>
                <View style={[styles.viewCampos, styles.viewCampospad]}>
                    ...
                    <AutoCompleteScreen
                        {...props}
                        placeholder={
                            props.template.secciones?.mapa.placeholderdir
                        }
                    />
                ...
                <View
                    ...
                    <TextInput
                        ...
                        maxLength={40}
                        placeholder={
                            props.template.secciones?.mapa.placeholderref
                        }
                        onChangeText={event => {
                            let obtrude = true;
                            let texture = /^[A-Za-z0-9\u00C1\u00E1\u00C9\u00E9\u00CD\u00ED\u00D3\u00F3\u00DA\u00FA\u00DC\u00FC\u00D1\u00F1\u00A0 ]+$/;
                            if (
                                !texture.test(event) &&
                                event !== '' &&
                                event !== null &&
